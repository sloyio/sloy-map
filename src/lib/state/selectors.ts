...
export const copyrightSelector = (state: State) =>
  state.sloy.config?.copyright || [];
export const filtersSelector = (state: State) =>
  state.sloy.config?.filters || [];
export const layersSelector = (state: State) => state.sloy.config?.layers || [];
export const sourcesSelector = (state: State) =>
  state.sloy.config?.sources || [];
