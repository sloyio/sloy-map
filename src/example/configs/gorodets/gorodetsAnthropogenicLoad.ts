...
export const gorodetsAnthropogenicLoad: InputSloyLayer = {
  id: "gorodets-anthropogenicload",
  title: "Антропогенная нагрузка",
  filters: [
    {
      title: "Степени нагрузки",
      type: "string[]",
      filterVisualizations: [
        "gorodetsAnthropogenicLoadLineLayer",
        "gorodetsAnthropogenicLoadFillLayer",
      ],
      source: "gorodetsAnthropogenicLoadLayerSource",
      property: "АН",
      totalType: "percent",
      postfix: "шт.",
      sortType: "config",
  ...
  visualizations: [
    {
      id: "gorodetsAnthropogenicLoadLineLayer",
      source: "gorodetsAnthropogenicLoadLayerSource",
      openable: true,
      type: "map",
      property: "АН",
    ...
    {
      id: "gorodetsAnthropogenicLoadFillLayer",
      source: "gorodetsAnthropogenicLoadLayerSource",
      openable: true,
      type: "map",
      property: "АН",
...
export const gorodetsAnthropogenicLoadSource: InputSloySource = {
  id: "gorodetsAnthropogenicLoadLayerSource",
  path: "/gorodets-anthropogenic-load.geojson",
  type: "geojson",
